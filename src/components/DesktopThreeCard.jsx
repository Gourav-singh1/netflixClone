...
import CardData from "./DesktopThreeCardData";
function DesktopThreeCard() {
  ...
  return (
    <>
      <Container>
        <Row className="py-5">
          {CardData.map((value) => {
            const { id, Imgage } = value;
            return (
              <Col sm={6} md={4} className="pt-4">
                <div className="overflow-hidden rounded-4" key={id}>
                  <div className="overflow-hidden rounded-4">
                    <div className=" position-relative hover_heard transition_600">
                      <img data-aos="zoom-in"  ata-aos-easing="ease-in-sine"
...
export default DesktopThreeCard;
